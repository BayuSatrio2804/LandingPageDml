...
export const TOKENS = {
   ...
   *
   * Nilai retheme "abu-biru" semula #4F6D95, tapi itu membuat portDim
   * (peta rute beranda, route-map.tsx) nyaris tak terbeda dari portLit
   * (TOKENS.accent) — 2,38:1, di bawah ambang 2,5:1 di route-map.test.ts.
   * #577195 sedikit lebih terang: tetap lolos 3:1 di atas surface/surface2,
   * dan memberi jarak 2,53:1 terhadap accent.
   */
  line: "#577195",
  ink: "#232830",
  inkMuted: "#5C6068",
  ...
  danger: "#B32222",
  /**
   * Bidang gelap hero. Bidang gelap paling dalam di situs ini — lebih gelap
   * dari darkField seksi-seksi lain di bawah — dan karena itu tidak
   * diturunkan dari surface mana pun. Sebelum Plan 6 nilainya ditulis
   * sebagai hex mentah di className hero.
   */
  heroGround: "#0B1424",
  /**
   ...
   */
  accentLift: "#5B84C8",
  /** Bidang gelap seksi (klien, CTA), lebih terang dari heroGround supaya hero tetap yang paling dalam. */
  darkField: "#0F1B2E",
  /** Variasi darkField untuk gradasi: ujung terang gradien seksi gelap. */
  darkFieldLift: "#132238",
  /** Variasi darkField untuk gradasi: ujung tergelap gradien seksi gelap. */
  darkFieldDeep: "#0C1626",
} as const;
